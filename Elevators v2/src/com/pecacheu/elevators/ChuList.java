...
public class ChuList<E> extends ArrayList<E> {
    ...
    public String join(String sep) {
        String str = "";
        for (int i = 0, l = super.size(); i < l; i++)
            str += (i == 0 ? "" : sep) + super.get(i);
        return str;
    }
    ...
    public ChuList<E> subList(int fromIndex, int toIndex) {
        ...
        if (toIndex > super.size()) toIndex = super.size();
        List<E> list;
        if (fromIndex > toIndex) list = super.subList(toIndex, fromIndex);
        else list = super.subList(fromIndex, toIndex);
        return new ChuList<E>(list);
    }
    ...
    public ChuIterator<E> chuIterator() {
        return new ChuIterator<E>(this);
    }
